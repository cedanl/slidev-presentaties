...
🔄 Transitie:
"Maar eerst, laten we eerlijk zijn over de uitdagingen..."
-->
...
- **Visueel design begrip** - Claude "ziet" niet hoe slides eruitzien, werkt alleen met code
- **Tekstoverloop problemen** - Te veel content, verkeerde marges, onjuiste font sizes
- **Achtergrond issues** - Gebruikt soms verkeerde methode voor backgrounds

</div>

<div class="mt-2" style="font-size: 0.85rem; line-height: 1.5;">

### Oplossing: Strikte guardrails ✅

- **Spacing regels** - Altijd `mt-2` of `mt-4` max, nooit groter
- **Font size regels** - Start met `0.85rem` voor body text
- **Content limieten** - Max 3-4 bullets per slide
- **Validatie checklist** - Test elke slide in browser voor oplevering
...
📌 Key points:
- Eerlijk over de beperkingen van AI
- Claude begrijpt design niet visueel
- Oplossing via strikte regels in CLAUDE.md
- Validatie is essentieel

💡 Benadrukt:
"Door deze guardrails werkt het 95% van de tijd perfect"

🔄 Transitie:
"Ondanks deze uitdagingen leveren de voordelen veel meer op..."
-->
